<nav class="sidebar sidebar-offcanvas d-flex flex-column" id="sidebar">
    <ul class="nav pt-3 flex-grow-1">
        <li class="nav-item{{ request()->routeIs('supplier-panel.dashboard') ? ' active' : '' }}">
            <a class="nav-link" href="{{ route('supplier-panel.dashboard') }}">
                <i class="mdi mdi-view-dashboard menu-icon"></i>
                <span class="menu-title">Dashboard</span>
            </a>
        </li>
        <li class="nav-item{{ request()->routeIs('supplier-panel.jobs') ? ' active' : '' }}">
        ...
        <li class="nav-item{{ request()->routeIs('supplier-panel.won.jobs') ? ' active' : '' }}">
        ...
        <li class="nav-item{{ request()->routeIs('supplier-panel.notifications.*') ? ' active' : '' }}">
        ...
        <li class="nav-item{{ request()->routeIs('supplier-panel.early.jobs') ? ' active' : '' }}">
        ...
        @endhasFeature
        <li class="nav-item{{ request()->routeIs('supplier-panel.reports') ? ' active' : '' }}">
        ...
        <li class="nav-item{{ request()->routeIs('supplier-panel.analytics') ? ' active' : '' }}">
        ...
        @endhasFeature
        <li class="nav-item{{ request()->routeIs('supplier-panel.activity') ? ' active' : '' }}">
            <a class="nav-link" href="{{ route('supplier-panel.activity') }}">
                <i class="mdi mdi-history menu-icon"></i>
                <span class="menu-title">Activity</span>
            </a>
        </li>
        <li class="nav-item{{ request()->routeIs('supplier-panel.profile') ? ' active' : '' }}">
            <a class="nav-link" href="{{ route('supplier-panel.profile') }}">
                <i class="mdi mdi-account-circle menu-icon"></i>
                <span class="menu-title">Profile</span>
            </a>
        </li>
        <li class="nav-item{{ request()->routeIs('supplier-panel.subscription.*') ? ' active' : '' }}">
            <a class="nav-link" href="{{ route('supplier-panel.subscription.index') }}">
