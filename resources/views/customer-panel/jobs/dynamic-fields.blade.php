        ...
        @foreach($fields as $field)
            ...
            <div class="col-md-6 mb-3">
                ...
                @if($field->field_type == 'text')
                    <input type="text" name="{{ $baseName }}" class="form-control" value="{{ $currentValue ?? '' }}" placeholder="{{ $field->placeholder ?? '' }}" {{ $required }}>
                    <div class="form-text">{{ $field->help_text ?? '' }}</div>
                @elseif($field->field_type == 'number')
                    <input type="number" name="{{ $baseName }}" class="form-control" value="{{ $currentValue ?? '' }}" placeholder="{{ $field->placeholder ?? '' }}" {{ $required }}>
                    <div class="form-text">{{ $field->help_text ?? '' }}</div>
                @elseif($field->field_type == 'date')
                    <input type="date" name="{{ $baseName }}" class="form-control" value="{{ $currentValue ?? '' }}" placeholder="{{ $field->placeholder ?? '' }}" {{ $required }}>
                    <div class="form-text">{{ $field->help_text ?? '' }}</div>
                @elseif($field->field_type == 'file')
                    <input type="file" name="{{ $baseName }}[]" class="form-control" placeholder="{{ $field->placeholder ?? '' }}" {{ $required }} multiple>
                ...
                @elseif($field->field_type == 'textarea')
                    <textarea name="{{ $baseName }}" rows="4" class="form-control" placeholder="{{ $field->placeholder ?? '' }}" {{ $required }}>{{ $currentValue ?? '' }}</textarea>
                    <div class="form-text">{{ $field->help_text ?? '' }}</div>
                ...
                @elseif($field->field_type == 'checkbox')
                    ...
                    <div class="form-text">{{ $field->help_text ?? '' }}</div>
                @else
                    <input type="text" name="{{ $baseName }}" class="form-control" value="{{ $currentValue ?? '' }}" {{ $required }}>
                @endif
            </div>
        @endforeach
    </div>
