...
<div class="content-wrapper p-3">
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-between gap-3">
                    ...
                    <div class="text-lg-end">
                        <div class="d-flex justify-content-lg-end gap-2 mb-2">
                            <button type="button" class="btn btn-sm btn-light border rounded-circle text-primary view-job-btn" title="View Job">
                                <i class="fa fa-eye"></i>
                            </button>
                            <button  class="btn btn-sm btn-light border rounded-circle edit-job-btn" title="Edit">
    ...
    <div class="modal fade" id="postjobmodal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="postjobmodalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-d ialog-scrollable">
