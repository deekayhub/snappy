    ...
    <div class="navbar-menu-wrapper d-flex align-items-top border-bottom" style="height: 80px;">
        <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                <a class="nav-link dropdown-toggle border rounded-pill px-3" id="CustomerUserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                    <span class="profile-text">{{ ucfirst(Auth::user()->name) }}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="CustomerUserDropdown">
